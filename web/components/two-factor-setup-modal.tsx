...
import { useAuth, useTwoFactor, ValidationError } from "next-sanctum";
                    ...
                    <div className="mx-auto flex max-w-md overflow-hidden">
                        <div className="mx-auto aspect-square w-64 rounded-lg border border-border">
                            <div className="z-10 flex h-full w-full items-center justify-center p-3">
                                {qrCodeSvg ? (
                                    <div
                                        className="aspect-square w-full rounded-lg bg-background p-3 [&_svg]:size-full"
    ...
    const submit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (error instanceof ValidationError) {
                setCodeError(error.errors.code?.[0]);
            } else {
                setCodeError("The provided code was invalid.");
            }
        } finally {
            setProcessing(false);
        }
